export const marketsConstants = {
    ...
    SOLVE_MULTI_BET_MARKET_REQUEST: 'SOLVE_MULTI_BET_MARKET_REQUEST',
    SOLVE_MULTI_BET_MARKET_SUCCESS: 'SOLVE_MULTI_BET_MARKET_SUCCESS',
    SOLVE_MULTI_BET_MARKET_FAILURE: 'SOLVE_MULTI_BET_MARKET_FAILURE',
