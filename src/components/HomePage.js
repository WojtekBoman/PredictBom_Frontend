          ...
          <Col sm={6}>
            ...
            <div className="rules home-info">
              ...
              <p className="text-muted">
                ...
                interesujących rynkach prognoz. Ceny akcji wahają się między 0 a
                1 $, gdzie za każdą akcję na poprawną opcję zakładową otrzymują
                1 $. Wykaż się umiejętnosciami prognostycznymi i kupuj akcje po
                jak najbardziej korzystnych cenach i sprzedawaj je aby jak
                najbardziej zwiększyć swój budżet. Zakupione akcje znajdziesz w
                zakładce kontrakty. Aby gra była uczciwa i najbogatsi gracze nie
                wykupowali wszystkich akcji dla danego rynku,{" "}
                <strong>
        ...
        {!this.props.loggedIn && (
          <div className="text-center">
            <LinkContainer to="/register" style={{ marginRight: "10px" }}>
              <Button variant="dark">Załóż konto</Button>
            </LinkContainer>
            <LinkContainer to="/login">
              <Button variant="dark">Zaloguj się</Button>
            </LinkContainer>
          </div>
        )}
        <div className="text-center">
          <LinkContainer to="/markets" style={{ margin: "5px" }}>
            <Button variant="dark">Przeglądaj dostępne rynki</Button>
          </LinkContainer>
        </div>
      </Container>
    );
